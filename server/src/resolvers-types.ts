...
> = {
  buildTx?: Resolver<
    ResolversTypes['TxBody'],
    ParentType,
    ContextType,
    RequireFields<QueryBuildTxArgs, 'paymentAddress' | 'stakeAddress' | 'value'>
  >;
  submitTx?: Resolver<
    ResolversTypes['TxResult'],
    ParentType,
    ContextType,
    RequireFields<QuerySubmitTxArgs, 'tx'>
  >;
  wallet?: Resolver<
    ResolversTypes['Wallet'],
    ParentType,
    ContextType,
    RequireFields<QueryWalletArgs, 'stakeAddress'>
  >;
};

export type TxResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['Tx'] = ResolversParentTypes['Tx'],
> = {
...
export type TxBodyResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TxBody'] = ResolversParentTypes['TxBody'],
> = {
  hex?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TxResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TxResult'] = ResolversParentTypes['TxResult'],
> = {
